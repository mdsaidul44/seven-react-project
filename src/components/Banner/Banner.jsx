...
const Banner = () => {
    return (
        <div className="my-8 lg:mx-28">
            <div className="lg:w-[1300px] h-[500px] bg-black rounded-[20px] bg-cover bg-[url('https://i.ibb.co/q1Lm2gh/chefs-demonstrating-cooking-skills-contest.jpg')]">
                <div className="lg:p-36 text-center ">
